...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#F3F4F6] flex items-center justify-center p-4 font-sans">
      <div className="w-full max-w-[1000px] min-h-[600px] h-auto md:h-[600px] bg-white rounded-2xl shadow-2xl flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="w-full md:w-[40%] bg-burgundy text-white p-8 md:p-10 flex flex-col justify-between relative overflow-hidden shrink-0">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-2xl md:text-3xl font-bold mb-4 leading-tight">
              Teacher Schedule<br className="hidden md:block" />
          ...
          <div className="relative z-10 mt-8 md:mt-auto text-sm opacity-80">
            Teaching Team
          </div>
        </div>
          ...
          <div className="w-full max-w-[400px]">
            ...
            <div className="flex justify-center gap-4 mb-6">
              <button
                ...
                className={`px-8 py-2.5 rounded-lg text-sm font-semibold transition-all ${role === 'teacher'
              ...
              <button
                ...
                className={`px-8 py-2.5 rounded-lg text-sm font-semibold transition-all ${role === 'manager'
                  ? 'bg-burgundy text-white border-transparent'
                  : 'bg-white text-burgundy border border-burgundy'
                  }`}
              >
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="flex items-center">
                <input
                  type="checkbox"
                  id="remember"
                  className="w-4 h-4 rounded border-slate-300 text-burgundy focus:ring-burgundy/20"
                />
