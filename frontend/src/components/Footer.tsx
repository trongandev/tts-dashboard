  ...
  return (
    <footer className="mt-8 pt-6 pb-24 md:pb-6 border-t border-slate-200 text-center space-y-2">
      ...
      <p className="text-xs text-slate-400 max-w-2xl mx-auto mt-4 leading-relaxed">
        Sản phẩm này phục vụ với mục đích giúp đỡ mentor MindX kiểm tra công lương của mình rõ ràng hơn. Sản phẩm có sử dụng API chính chủ từ phía MindX. Nếu có bất kỳ sai phạm hay vi phạm bản quyền vui lòng gửi mail cho tác giả.
      </p>
    </footer>
  );
}
