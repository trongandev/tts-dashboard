...
import { DollarSign, Save, Loader2, TrendingUp, Calendar, CheckSquare, Undo2 } from 'lucide-react';
...
export default function Salary() {
  ...
  const [selectedRank, setSelectedRank] = useState('T0');
      ...
      toast((t) => (
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-slate-800">Đã lưu rank thành công!</span>
          </div>
          <button
            onClick={() => {
              toast.dismiss(t.id);
